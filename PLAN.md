...
**Next steps toward the MVP** are the vertical slices in *Phase 7 → Execution plan (approved build order)* below, which cover functional cases FT-01 through FT-14. The Step 0 prerequisite (Argon2id demo credentials) and Step 1 (persistence layer) are complete and evidenced (`docs/evidence/2026-07-13-phase7-step0-argon2id.md`, `docs/evidence/2026-07-13-phase7-step1-persistence.md`); Step 2 (auth slice — login/logout, opaque tokens, RFC 9457 problems) is the next slice. The MVP as a whole is defined by FT-01 through FT-19 in `docs/functional-test-specification.md`: Phase 7 delivers the API cases, Phase 8 the label/dashboard cases (FT-17, FT-18), Phase 9 the configuration/observability cases and retained evidence (FT-15, FT-16), and Phase 10 plus a scope review close FT-19. Artifacts belonging to phases not yet implemented and evidenced remain **provisional drafts**.
